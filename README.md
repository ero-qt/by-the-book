...
Every question it asks is one of three words, always the same word at the same moment: Go? before research and again before the first test is written, Approve? before anything is created, and Review? after the last commit. What a question gates goes in chat first, the question is the last line of the turn and holds nothing but the word, and you answer in chat. Nothing is created, committed, or opened before you say so, and every issue, commit message, and pull request body is written the way you would write it.
